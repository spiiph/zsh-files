...
# Modifications: Henrik Öhman (speeph at gmail.com)
#
...
setopt PushdIgnoreDups     2>/dev/null
     # Don't reverse - and + after cd
setopt NoPushdMinus        2>/dev/null
...
# UTF-8 keybindings for cygwin/xterm
bindkey $'\xC3\xA6' forward-word                   # <A-f>
bindkey $'\xC3\xA2' backward-word                  # <A-b>
bindkey $'\xC3\xA4' kill-word                      # <A-d>
bindkey $'\xC2\x88' backward-kill-word             # <A-BS>
...
autoload -U compinit; compinit -C # Set up the required completion functions
